...
export default async function NewConsentPage({ searchParams }: { searchParams: Promise<{ driverId?: string }> }) {
    ...
    return (
        <div className="p-8 sm:p-12 mb-20 bg-white dark:bg-slate-900 min-h-full max-w-3xl mx-auto">
            <div className="mb-6">
                <Link href="/consents" className="text-sm font-medium text-[#3E91DE] hover:text-[#143A82] dark:text-white flex items-center gap-1 transition-colors">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-[#77C7EC]/20 pt-4 mt-2">
                                <div className="grid gap-2">
                                    ...
                                    <select
                                        ...
                                        name="type"
                                        required
                                        className="flex h-10 w-full rounded-md border border-[#77C7EC]/40 bg-white px-3 py-2 text-sm text-[#143A82] dark:text-white shadow-sm"
                                    >
