...
export async function GET(request: Request) {
    ...
    const tables = [
        ...
        { name: "Company.address", sql: `ALTER TABLE "Company" ADD COLUMN "address" TEXT` },
        { name: "Company.city", sql: `ALTER TABLE "Company" ADD COLUMN "city" TEXT` },
        { name: "Company.state", sql: `ALTER TABLE "Company" ADD COLUMN "state" TEXT` },
        { name: "Company.zip", sql: `ALTER TABLE "Company" ADD COLUMN "zip" TEXT` },
